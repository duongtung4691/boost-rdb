...
namespace boost { namespace rdb { namespace sql {
  ...
  struct NAME##_ : table_<NAME##_base, Alias == -1>, singleton< NAME##_<Alias> > {  \
    ...
    dynamic_table dynamic() const { return dynamic_table(new dynamic_table::wrapper<this_table>(*this)); } \
  ...
  typedef expression< column<this_table, type::sql_type, NAME##_base> > NAME##_type;  \
  NAME##_type NAME;  \
  struct NAME##_member {  \
